...
/**
 * Handles calculation logic, memory, and history management.
 */
public class CalculatorEngine {
    ...
    public void addToMemory(double v) {
        memory += v;
    }

    public void subtractFromMemory(double v) {
        memory -= v;
    }
    ...
    //  HISTORY METHODS
    // ═══════════════════════════════════════════════════════════════════
    public void addCalculationToHistory(String entry) {
        addToHistory(entry, false);
    }

    public void addConversionToHistory(String entry) {
    ...
    public List<String> getConvHistory() {
        return convHistory;
    }
}